...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let voices = []; // Hold the list of available voices.

    // Fetch and store the available voices. This is often asynchronous.
    ...
    // Function to speak a given text in Greek.
    function speak(text) {
        ...
        // Attempt to find a Greek voice.
        const greekVoice = voices.find(voice => voice.lang === 'el-GR');
        if (greekVoice) {
            utterance.voice = greekVoice;
        } else {
            console.warn('No Greek (el-GR) voice found. Using default for the language.');
        }
